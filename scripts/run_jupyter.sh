...
docker exec -ti $containerId bash -c 'cd /workspace/ReadOrSee;source env/bin/activate;cd notebooks;jupyter notebook --ip=0.0.0.0 --no-browser --port '"$2"' --allow-root'
